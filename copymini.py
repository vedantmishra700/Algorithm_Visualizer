...
from mergesortnew import merge_sort
...
minlabel=Label(root,text='Algorithm : ',font=("new roman",16,"italic bold"),bg='#05897A',width=10,fg="black",relief=GROOVE,bd=5)
minlabel.place(x=0,y=0)

algo_menu = ttk.Combobox(root,width=15,font=("new roman",19,"italic bold"),textvariable=selected_algorithm,values=['Bubble Sort','Insertion Sort','Merge Sort','Selection Sort'])
...
sizevaluelabel=Label(root,text="Size : ",font=("new roman",16,"italic bold"),bg='#05897A',width=8,fg="black",height=2,relief=GROOVE,bd=5)
sizevaluelabel.place(x=0,y=60)
sizevalue=Scale(root,from_=0,to=30,resolution=1,orient=HORIZONTAL,font=("arial",14,"italic bold"),relief=GROOVE,bd=2,width=8)
sizevalue.place(x=130,y=60)

minvaluelabel=Label(root,text="Min Value : ",font=("new roman",12,"italic bold"),bg='#05897A',width=10,fg="black",height=2,relief=GROOVE,bd=5)
...
maxvaluelabel=Label(root,text="Max Value : ",font=("new roman",12,"italic bold"),bg='#05897A',width=10,fg="black",height=2,relief=GROOVE,bd=5)
...
speedlabel=Label(root,text="Speed : ",font=("new roman",12,"italic bold"),bg='#05897A',width=10,fg="black",relief=GROOVE,bd=5)
speedlabel.place(x=400,y=0)

speedscale=Scale(root,from_=0.1,to=2.0,resolution=0.2,length=200,digits=2,orient=HORIZONTAL,font=("ALGERIAN",14,"italic bold"),relief=GROOVE,bd=2,width=10)
